...
export CIBW_TEST_COMMAND="python -c 'import actiongate; print(\"actiongate imported from:\", actiongate.__file__)'" ## New for testing update in gha post test
...
python -c "import actiongate; print('actiongate imported from:', actiongate.__file__)"
